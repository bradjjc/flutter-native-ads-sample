...
class NativeAdFactoryExample implements NativeAdFactory {
    ...
    public NativeAdView createNativeAd(
        ...
        final NativeAdView adView =
                (NativeAdView) layoutInflater.inflate(R.layout.list_tile_native_ad, null);
        final TextView headlineView = adView.findViewById(R.id.tv_list_tile_native_ad_headline);
        final TextView bodyView = adView.findViewById(R.id.tv_list_tile_native_ad_body);
